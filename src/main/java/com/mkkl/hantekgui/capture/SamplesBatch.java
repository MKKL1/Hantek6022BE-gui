...
public class SamplesBatch {
    ...
    public void concatenate(SamplesBatch samplesBatch2) {
        ...
        ch1Data = Arrays.copyOf(ch1Data, ch1Data.length + samplesBatch2.length);
        ch2Data = Arrays.copyOf(ch2Data, ch2Data.length + samplesBatch2.length);

        System.arraycopy(samplesBatch2.ch1Data, 0, ch1Data, oldlength, samplesBatch2.length);
        System.arraycopy(samplesBatch2.ch2Data, 0, ch2Data, oldlength, samplesBatch2.length);
    }
}
