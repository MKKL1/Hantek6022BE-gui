...
//Class copied from apache common collections to add reversed iterator to it
...
public class CircularFifoQueue<E> extends AbstractCollection<E>
    ...
    public Iterator<E> descendingIterator() {
        return new Iterator<E>() {
            ...
            private int index = decrement(end);
            private final int startIndex = decrement(start);
            private int lastReturnedIndex = -1;
            private boolean isLast = full;

            @Override
            public boolean hasNext() {
                return isLast || index != startIndex;
            }
